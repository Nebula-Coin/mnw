...
export async function getHardwareWalletKeys(path, xpub = false, verify = true) {
    try {
        ...
        if (!cHardwareWallet || transport._disconnectEmitted) {
            ...
            cHardwareWallet = new AppBtc({ transport, currency: 'Nebula' });
        }
...
export const LEDGER_ERRS = new Map([
    ...
    [25870, 'Open the Nebula app on your device'],
    [25873, 'Open the Nebula app on your device'],
    [57408, 'Navigate to the Nebula app on your device'],
    [27157, 'Wrong app! Open the Nebula app on your device'],
    [27266, 'Wrong app! Open the Nebula app on your device'],
    [27904, 'Wrong app! Open the Nebula app on your device'],
