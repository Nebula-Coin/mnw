...
/** BIP21 coin prefix */
export const BIP21_PREFIX = 'nebula';
...
export const cChainParams = reactive({
    ...
    main: {
        ...
        MASTERNODE_PORT: 1818,
        // A list of Labs-trusted explorers
        Explorers: [
            // Display name      Blockbook-compatible API base
            { name: 'Nebula', url: 'https://explorer.nebulaproject.io' },
        ],
        Nodes: [{ name: 'Nebula RPC', url: 'https://mnwrpc.nebulaproject.io/mainnet' }],
        Consensus: {
            // Network upgrades
    ...
    testnet: {
        ...
        BIP44_TYPE_LEDGER: 1,
        PROTOCOL_VERSION: 70926,
        MASTERNODE_PORT: 1918,
        // A list of Labs-trusted explorers
        Explorers: [
            // Display name      Blockbook-compatible API base
            { name: 'Nebula', url: 'https://testnetexplorer.nebulaproject.io' },
        ],
        Nodes: [{ name: 'Nebula RPC', url: 'https://rpc.nebulaproject.io/testnet' }],
        Consensus: {
            // Network upgrades
            UPGRADE_V6_0: undefined,
        },
        ...
        maxPaymentCycles: 20,
        maxPayment: 10 * 144 * COIN, // 144 blocks of 10 tNBLA
