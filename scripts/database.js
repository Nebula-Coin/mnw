...
export class Database {
    ...
    async addAccount(account) {
        ...
        if (!(account instanceof Account)) {
            ...
            createAlert(
                'warning',
                '<b>Account Creation Error</b><br>Logs were dumped in your Browser Console<br>Please submit these privately to Nebula Developers!'
            );
            return false;
        }
    ...
    async updateAccount(account, allowDeletion = false) {
        ...
        if (!(account instanceof Account)) {
            ...
            createAlert(
                'warning',
                '<b>DB Update Error</b><br>Your wallet is safe, logs were dumped in your Browser Console<br>Please submit these privately to Nebula Developers!'
            );
            return false;
        }
        ...
        if (!cDBAccount) {
            ...
            createAlert(
                'warning',
                '<b>DB Update Error</b><br>Logs were dumped in your Browser Console<br>Please submit these privately to Nebula Developers!'
            );
            return false;
        }
