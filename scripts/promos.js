...
/** The fee in Sats to use for Creating or Redeeming Nebula Promos */
...
/**
 * Sets the mode of the Nebula Promos UI
...
/**
 * Create a new 'Nebula Promos' code with a webworker
...
/** Export and download all Nebula Promos data in to a CSV format */
export async function promosToCSV() {
    const arrCSV = [
        // Titles
        ['Promo Code', 'NBLA (Remaining)', 'Funding Address'],
        // Content
    ];
...
/**
 * @type {Worker?} - The thread used for the Nebula Promos redeem process
 */
export let promoThread = null;

/**
 * Derive a 'Nebula Promos' code with a webworker
...
/**
 * Prompt a QR scan for a Nebula Promos code
 */
