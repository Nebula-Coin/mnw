export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Construido com 💜 por NebulaProject 🇧🇷', //Built with 💜 by NebulaProject

    // Intro
    loading: 'Carregando', //Loading
    loadingTitle: 'A Minha Carteira NebulaProject', //My NebulaProject Wallet is
    ...
    dCardOneDesc:
        'Crie uma carteira nova NebulaProject, oferecendo os métodos de backup e segurança mais seguros.', //Create a new NebulaProject wallet, offering the most secure backup & security methods.
    ...
    dCardFourDesc:
        'Importar uma carteira NebulaProject usando uma chave privada, xpriv ou Seed Phrase.', //Import a NebulaProject wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    encryptFirstForContacts:
        'Quando você pressionar "{button}" no dashboard você poderá criar um contato para receber NBLA mais facilmente! ', //Once you hit "{button}" in the Dashboard, you can create a Contact to make receiving NBLA easier!
    ...
    pivxPromos:
        'é um sistema descentralizado de códigos de presente com valor em NBLA', // [...] is a decentralised system for gift codes worth NBLA
    // NOTE: on this line, if possible, leave 'NebulaProject Promos' untranslated
    redeemInput: "Digite o seu código 'NebulaProject Promos'", //Enter your 'NebulaProject Promos' code
    ...
    settingsPivxNode: 'Escolha um node NebulaProject:', //Choose a NebulaProject node:
    ...
    INVALID_ADDRESS: '<b>Endereço NebulaProject inválido!</b><br> {address}', //<b>Invalid NebulaProject address!</b><br> {address}
    ...
    BAD_ADDR_LENGTH:
        '<b>Endereço NebulaProject inválido!<b><br>Comprimento incorreto ({addressLength})', //<b>Invalid NebulaProject address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX:
        '<b>Endereço NebulaProject inválido!<b><br>Prefixo inválido {address} (Deve começar com {addressPrefix})', //<b>Invalid NebulaProject address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
    ...
    WALLET_HARDWARE_WALLET:
        '<b>Carteira de hardware pronta!</b><br>Mantenha a sua {hardwareWallet} conectada, desbloqueada e na aplicação NebulaProject', //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the NebulaProject app
