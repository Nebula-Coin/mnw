export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Binuo nang may 💜 ng NebulaProject 🇵🇭', //Built with 💜 by NebulaProject

    // Intro
    loading: 'Loading', //Loading
    loadingTitle: 'My NebulaProject wallet ay', //My NebulaProject Wallet is
    ...
    dCardOneDesc:
        "Gumawa ng bagong NebulaProject wallet, ito'y nag aalok ng pinaka-ligtas na backup at mga paraang pang seguridad", //Create a new NebulaProject wallet, offering the most secure backup & security methods.
    ...
    dCardFourDesc:
        'I-import ang iyong NebulaProject wallet gamit ang Private Key, xpriv, o Seed Phrase', //Import a NebulaProject wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    encryptFirstForContacts:
        'Sa sandaling mapindot mo ang "{button}" sa Dashboard, maaari kang lumikha ng Contact upang gawing mas madali ang pagtanggap ng NBLA!', //Once you hit "{button}" in the Dashboard, you can create a Contact to make receiving NBLA easier!
    ...
    pivxPromos:
        'ay isang desentralisadong sistema para sa gift code na nag kakahalaga ng NBLA', // [...] is a decentralised system for gift codes worth NBLA
    // NOTE: on this line, if possible, leave 'NebulaProject Promos' untranslated
    redeemInput: "Ipasok and iyong 'NebulaProject Promos'code", //Enter your \'NebulaProject Promos\' code
    ...
    INVALID_ADDRESS:
        '<b>Ang NebulaProject address na ito ay hindi wasto!</b><br> {address}', //<b>Invalid NebulaProject address!</b><br> {address}
    ...
    BAD_ADDR_LENGTH:
        '<b>Hindi wasto ang NebulaProject address!<b><br>Bad lenght({addressLength})', //<b>Invalid NebulaProject address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX:
        '<b>Hindi wasto ang NebulaProject address!<b><br>Bad prefix{address} (Ito ay dapat nag sisimula sa{addressPrefix})', //<b>Invalid NebulaProject address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
    ...
    WALLET_HARDWARE_WALLET:
        '<b>Handa na ang Hardware wallet!</b><br>Pakiusap panatilihin mo na ang {hardwareWallet} ay naka plugged in, naka bukas, at nasa NebulaProject app ', //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the NebulaProject app
