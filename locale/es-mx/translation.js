export default {
    ...
    // NOTA: Las variables que inserta MNW se denotan con corchetes {}, por ejemplo, {button}, NO traduzcas las variables, pero colócalas donde tenga más sentido.
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Hecho con 💜 por NebulaProject 🇲🇽', //Built with 💜 by NebulaProject

    // Intro
    loading: 'Cargando', //Loading
    loadingTitle: 'My NebulaProject Wallet está', //My Nebula Project Wallet is
    ...
    dCardOneDesc:
        'Crear una nueva NebulaProject Wallet, ofreciendo los métodos de respaldo y seguridad más seguros.', //Create a NebulaProject PIVX wallet, offering the most secure backup & security methods.
    dCardOneButton: 'Crear una nueva Nebula Wallet', //Create A New Wallet
    ...
    dCardFourDesc:
        'Importar una wallet de NebulaProject usando una llave privada, xpriv o frase de semilla.', //Import a NebulaProject wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    pivxPromos:
        'es un sistema descentralizado de códigos de regalo comprados con NBLA', // [...] is a decentralised system for gift codes worth NBLA
    // NOTE: on this line, if possible, leave 'NebulaProject Promos' untranslated
    redeemInput: 'Introduce tu código de NebulaProject Promos', //Enter your 'NebulaProject Promos' code
    ...
    time_to_sync:
        'El tiempo en segundos que tardó MNW en sincronizarse por última vez.', //The time in seconds it took for MNW to last synchronise.
    transaction:
    ...
    INVALID_ADDRESS: '<b>¡Dirección NebulaProject no válida!</b><br> {address}', //<b>Invalid NebulaProject address!</b><br> {address}
    ...
    BAD_ADDR_LENGTH:
        '<b>¡Dirección NebulaProject no válida!<b><br>Longitud incorrecta ({addressLength})', //<b>Invalid NebulaProject address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX:
        '<b>¡Dirección NebulaProject no válida!<b><br>Prefijo {address} incorrecto (debe comenzar con {addressPrefix})', //<b>Invalid NebulaProject address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
