export default {
    ...
    dCardFourDesc: '', //Import a NebulaProject wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    encryptFirstForContacts: '', //Once you hit "{button}" in the Dashboard, you can create a Contact to make receiving NBLA easier!
    ...
    pivxPromos: '', // [...] is a decentralised system for gift codes worth NBLA
    // NOTE: on this line, if possible, leave 'NebulaProject Promos' untranslated
    redeemInput: '', //Enter your 'NebulaProject Promos' code
    ...
    BAD_ADDR_LENGTH: '', //<b>Invalid NebulaProject address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX: '', //<b>Invalid NebulaProject address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
    ...
    WALLET_HARDWARE_WALLET: '', //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the NebulaProject app
