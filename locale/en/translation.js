export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Built with 💜 by NebulaProject', //

    // Intro
    loading: 'Loading', //
    loadingTitle: 'My NebulaProject Wallet is', //
    ...
    dCardOneDesc:
        'Create a new NebulaProject wallet, offering the most secure backup & security methods.', //
    ...
    dCardFourDesc:
        'Import a NebulaProject wallet using a Private Key, xpriv, or Seed Phrase.', //
    ...
    encryptFirstForContacts:
        'Once you hit "{button}" in the Dashboard, you can create a Contact to make receiving NBLA easier!', //
    ...
    pivxPromos: 'is a decentralised system for gift codes worth NBLA', // [...] is a decentralised system for gift codes worth NBLA
    // NOTE: on this line, if possible, leave 'NebulaProject Promos' untranslated
    redeemInput: "Enter your 'NebulaProject Promos' code", //Enter your 'NebulaProject Promos' code
    ...
    settingsPivxNode: 'Choose a NebulaProject node:', //
    ...
    INVALID_ADDRESS: '<b>Invalid NebulaProject address!</b><br> {address}',
    ...
    BAD_ADDR_LENGTH:
        '<b>Invalid NebulaProject address!<b><br>Bad length ({addressLength})',
    BAD_ADDR_PREFIX:
        '<b>Invalid NebulaProject address!<b><br>Bad prefix {address} (Should start with {addressPrefix})',
    ...
    WALLET_HARDWARE_WALLET:
        '<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the NebulaProject app',
