export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Gemaakt met 💜 door NebulaProject', //

    // Intro
    loading: 'Bezig met laden', //
    loadingTitle: 'Mijn NebulaProject-portemonnee is', //
    ...
    dCardOneDesc:
        'Maak een nieuwe NebulaProject-portemonnee aan, met de meest veilige back-up- en beveiligingsmethoden.', //
    ...
    dCardThreeDesc:
        'Gebruik uw Ledger Hardware-portemonnee met de vertrouwde interface van MNW.', //
    dCardThreeButton: 'Toegang tot mijn Ledger', //

    dCardFourTitle: 'Ga naar', //
    dCardFourSubTitle: 'Mijn Portemonnee', //
    dCardFourDesc:
        'Importeer een NebulaProject-portemonnee met een privésleutel, xpriv, of seedzin.', //
    ...
    encryptFirstForContacts:
        'Zodra je "{button}" in het Dashboard selecteert, kun je een contact aanmaken om het ontvangen van NBLA gemakkelijker te maken!', //
    ...
    pivxPromos:
        'is een gedecentraliseerd systeem voor cadeaucodes ter waarde van NBLA', // [...] is a decentralised system for gift codes worth NBLA
    // NOTE: on this line, if possible, leave 'NebulaProject Promos' untranslated
    redeemInput: 'Voer uw "NebulaProject Promos" code in', //Enter your 'NebulaProject Promos' code
    ...
    settingsPivxNode: 'Kies een NebulaProject-knooppunt:', //
    ...
    time_to_sync:
        'De tijd in seconden die MNW nodig had om voor het laatst te synchroniseren.',
    transaction:
    ...
    popupSeedPhraseBadNote:
        'De seedzin is ofwel ongeldig of is niet gegenereerd door MNW.<br>Wil je nog steeds doorgaan?',
    ...
    popupProposalFinalisedNote:
        '<b>Gefeliciteerd met het lanceren van je voorstel!</b><br>Masternode-eigenaren kunnen je Stemhash gebruiken om te stemmen vanuit portefeuilles anders dan MNW, zorg er dus voor dat je deze toevoegt aan je forum post, indien van toepassing!',
    ...
    INVALID_ADDRESS: '<b>Ongeldig NebulaProject-adres!</b><br> {address}',
    ...
    BAD_ADDR_LENGTH:
        '<b>Ongeldig NebulaProject-adres!<b><br>Slechte lengte ({addressLength})',
    BAD_ADDR_PREFIX:
        '<b>Ongeldig NebulaProject-adres!<b><br>Ongeldige prefix {address} (Moet beginnen met {addressPrefix})',
