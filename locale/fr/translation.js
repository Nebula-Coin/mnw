export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Construit avec 💜 par NebulaProject FR 🇫🇷', //Built with 💜 by NebulaProject

    // Intro
    loading: 'Chargement', //Loading
    loadingTitle: 'Mon portefeuille NebulaProject', //My NebulaProject Wallet is
    ...
    dCardOneDesc:
        'Créer un nouveau portefeuille NebulaProject, qui offre les méthodes de sauvegarde et de sécurité les plus sûres.', //Create a new NebulaProject wallet, offering the most secure backup & security methods.
    ...
    dCardFourDesc:
        "Importer un portefeuille NebulaProject à l'aide d'une clé privée, d'un xpriv ou d'une phrase de démarrage.", //Import a NebulaProject wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    pivxPromos:
        "est un système décentralisé de codes cadeaux d'une valeur de NBLA", // [...] is a decentralised system for gift codes worth NBLA
    // NOTE: on this line, if possible, leave 'NebulaProject Promos' untranslated
    redeemInput: "Introduisez votre code'NebulaProject Promos", //Enter your 'NebulaProject Promos' code
    ...
    settingsPivxNode: 'Choisir un nœud NebulaProject :', //Choose a NebulaProject node:
    ...
    INVALID_ADDRESS: '<b>Adresse NebulaProject non valide !</b><br> {address}', //<b>Invalid NebulaProject address!</b><br> {address}
    ...
    BAD_ADDR_LENGTH:
        '<b>Adresse NebulaProject non valide!<b><br>Préfixe non valide {address} (Vous devez commencer par{addressPrefix})', //<b>Invalid NebulaProject address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX:
        '<b>Adresse NebulaProject non valide!<b><br>Préfixe non valide {address} (Vous devez commencer par{addressPrefix})', //<b>Invalid NebulaProject address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
    ...
    WALLET_HARDWARE_WALLET:
        " //<b>Portefeuille de Hardware prêt!</b><br>Gardez votre {hardwareWallet} connecté, déverrouillé et dans l'application NebulaProject", //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the NebulaProject app
