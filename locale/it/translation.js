export default {
    ...
    loadingTitle: 'Il mio Wallet NebulaProject', //My NebulaProject Wallet is
    ...
    dCardOneDesc:
        'Crea un nuovo Wallet NebulaProject, con metodi di sicurezza & di backup più sicuri.', //Create a new NebulaProject wallet, offering the most secure backup & security methods.
    ...
    dCardThreeDesc:
        'Utilizza il tuo wallet Ledger con la solita interfaccia di MNW.', //Use your Ledger Hardware wallet with MNW's familiar interface.
    dCardThreeButton: 'Accedi al mio Ledger', //Access my Ledger

    dCardFourTitle: 'Vai al ', //Go to
    dCardFourSubTitle: 'Mio Wallet', //My Wallet
    dCardFourDesc:
        'Importa un wallet NebulaProject usando una Chiave Privata, xpriv, o una Seed Phrase.', //Import a NebulaProject wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    encryptFirstForContacts:
        'Dopo aver premuto "{button}" nella Dashboard, puoi creare un contatto per facilitare la ricezione dei NBLA!', //Once you hit "{button}"in the Dashboard, you can create a Contact to make receiving NBLA easier!
    ...
    // NebulaProject Promos
    // NOTE: for this below line, continue the sentence "NebulaProject Promos [...]", since 'NebulaProject Promos' is a brand, it is not translated.
    pivxPromos: 'è un sistema decentralizzato per codici regalo con valore NBLA', // [...] is a decentralised system for gift codes worth NBLA
    // NOTE: on this line, if possible, leave 'NebulaProject Promos' untranslated
    redeemInput: "Inserisci il tuo codice 'NebulaProject Promos'", //Enter your 'NebulaProject Promos' code
    ...
    settingsPivxNode: 'Scegli un nodo NebulaProject', //Choose a NebulaProject node:
    ...
    popupSeedPhraseBadNote:
        'La frase seed non è valida o non è stata generata da MNW.<br>Vuoi comunque procedere?', //The seed phrase is either invalid or was not generated by MNW.<br>Do you still want to proceed?
    ...
    BAD_ADDR_LENGTH:
        '<b>Indirizzo NebulaProject non valido!<b><br>Lunghezza errata ({addressLength})', //<b>Invalid NebulaProject address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX:
        '<b>Indirizzo NebulaProject non valido!<b><br>Prefisso {address} errato (dovrebbe iniziare con {addressPrefix})', //<b>Invalid NebulaProject address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
