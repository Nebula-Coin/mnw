export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Mit 💜 erstellt - NebulaProject 🇩🇪', //Built with 💜 by NebulaProject

    // Intro
    loading: '...lädt...', //Loading
    loadingTitle: 'Meine NebulaProject Geldbörse', //My NebulaProject Wallet is
    ...
    dCardOneDesc:
        'Erstelle eine neue NebulaProject Geldbörse, unter verwendung neuester Sicherheits- & Backupmethoden.', //Create a new NebulaProject wallet, offering the most secure backup & security methods.
    ...
    dCardThreeDesc:
        'Benutze deine Ledger Hardware Geldbörse mit MNW als benutzerfreundliche Schnittstelle.', //Use your Ledger Hardware wallet with MNW's familiar interface.
    ...
    dCardFourDesc:
        'Importiere eine NebulaProject Geldbörse mittels Private Key, xpriv oder einer Seed Phrase', //Import a NebulaProject wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    pivxPromos: 'ist ein dezentrales System für NebulaProject Geschenk-Gutscheine', // [...] is a decentralised system for gift codes worth NBLA
    // NOTE: on this line, if possible, leave 'NebulaProject Promos' untranslated
    redeemInput: 'Gib deinen NebulaProject Promos Code ein', //Enter your 'NebulaProject Promos' code
    ...
    settingsPivxNode: 'Wähle einen NebulaProject Knoten', //Choose a NebulaProject node:
    ...
    INVALID_ADDRESS: '<b>Ungültige NebulaProject Adresse</b><br> {address}', //<b>Invalid NebulaProject address!</b><br> {address}
    ...
    BAD_ADDR_LENGTH:
        '<b>Ungültige NebulaProject Adresse!<b><br>Falsche Länge ({addressLength})', //<b>Invalid NebulaProject address!<b><br>Bad length ({addressLength})
    BAD_ADDR_PREFIX:
        '<b>Ungültige NebulaProject Adresse!<b><br>Falscher Prefixx {address} (Sollte eigentlich mit {addressPrefix} beginnen)', //<b>Invalid NebulaProject address!<b><br>Bad prefix {address} (Should start with {addressPrefix})
    ...
    WALLET_HARDWARE_WALLET:
        '<b>Hardware-Geldbörse bereit!</b><br>Bitte lass dein {hardwareWallet} eingesteckt, entsperrt und in der NebulaProject app aktiviert', //<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the NebulaProject app
