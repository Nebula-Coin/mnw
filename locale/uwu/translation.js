export default {
    ...
    // Footer
    footerBuiltWithPivxLabs: 'Built with wuv by NebulaProject 💜', //Built with 💜 by NebulaProject

    // Intro
    loading: 'Loading', //
    loadingTitle: 'My NebulaProject Wawwet is', //
    ...
    dCardOneDesc:
        'Cweate a new NebulaProject wawwet, offewing da most secuwur backup & securrrity methods.', //Create a new NebulaProject wallet, offering the most secure backup & security methods.
    ...
    dCardFourDesc:
        'Impowt a NebulaProject wawwet using a Pwivate Key, xpriv, or Seed Phrase.', //Import a NebulaProject wallet using a Private Key, xpriv, or Seed Phrase.
    ...
    encryptFirstForContacts:
        'Once yew hit "{button}" in the Dashboard, yew can cweate a Contact to make receiving NBLA easier!', //Once you hit "{button}" in the Dashboard, you can create a Contact to make receiving NBLA easier!
    ...
    pivxPromos: 'is a decentralised system for gifty cowodes worth NBLA', // [...] is a decentralised system for gift codes worth NBLA
    // NOTE: on this line, if possible, leave 'NebulaProject Promos' untranslated
    redeemInput: "Enter ur 'NebulaProject Promos' cowode", //Enter your 'NebulaProject Promos' code
    ...
    settingsPivxNode: 'Chowose a NebulaProject nowode pwease:', //Choose a NebulaProject node:
    ...
    NEW_PASSWORD_SUCCESS:
        "<b>Yowou're Secuwed!</b><br>Good Job, NebulaProject Pogchamp!", //'<b>You\'re Secured! 🔐</b><br>Nice stuff, Armoured PIVian!',
    ...
    INVALID_ADDRESS: '<b>Invawed NebulaProject addwess baka</b><br> {address} ', //<b>Invalid NebulaProject address!<b><br> {address}
    ...
    BAD_ADDR_LENGTH:
        '<b>Invawed NebulaProject addwess!</b><br>Bad wength ({addressLength})', //'<b>Invalid NebulaProject address!<b><br>Bad length ({addressLength})',
    BAD_ADDR_PREFIX:
        '<b>Invawed NebulaProject addwess! Baka!</b><br>Bad pwefix {address} (Should start with {addressPrefix})', //'<b>Invalid NebulaProject address!<b><br>Bad prefix {address} (Should start with {addressPrefix})',
    ...
    WALLET_HARDWARE_WALLET:
        '<b>Hawdware wawwet ready!</b><br>Pwease keep your {hardwareWallet} pwugged in, unwocked, and in da NebulaProject app ♥', //"<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the NebulaProject app",
